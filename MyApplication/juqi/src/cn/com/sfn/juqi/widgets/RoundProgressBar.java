...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		content = mTypedArray.getString(R.styleable.RoundProgressBar_text);
	...
	protected void onDraw(Canvas canvas) {
		...
		float textWidth = paint.measureText("两字"); // 测量字体宽度，我们需要根据字体的宽度设置在圆环中间
		canvas.drawText(content, centre - textWidth / 2, centre + textSize / 2,
				paint);
