    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if (size == 1) {
                ...
                textView.setBackgroundResource(R.color.color_3488ab);
                /*if (showTitle) {
                    if (i >= 1 && i < size) {
            ...
            textView.setTextColor(context.getResources().getColor(R.color.color_9adfff));
            // 高度
            float scale = context.getResources().getDisplayMetrics().density;
            int height = (int) (45 * scale + 0.5f);
            LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, height);
            params.setMargins(0,(int)(scale*5+0.5f),0,0);
