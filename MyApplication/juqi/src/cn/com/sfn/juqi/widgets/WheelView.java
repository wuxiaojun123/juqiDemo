...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF9ADFFF;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF9ADFFF;
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			System.out.println(itemsPaint.density);
			if(itemsPaint.density==3.0){
		...
		if (valuePaint == null) {
			...
			System.out.println("density值是"+valuePaint.density);
			if(valuePaint.density==3.0){
				valuePaint.setTextSize(TEXT_SIZE);//45,高分辨率机型
			}else{
