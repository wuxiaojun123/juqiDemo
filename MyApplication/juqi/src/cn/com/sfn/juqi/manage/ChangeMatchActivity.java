		...
		myhandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 1:
					...
					break;
				case 2:
					Toast.makeText(ChangeMatchActivity.this, "网络异常",
	...
	public void onClick(View v) {
		...
		case R.id.appoint_confirm_btn:
			...
			int rs = matchController.changeMatch(id,
					title.getText().toString(), Config.login_userid, startTime
							.getText().toString(), duration, number.getText()
							.toString(), iType, iFormat, fee.getText()
							.toString(), detail.getText().toString(), place
							.getText().toString(), placeDetail.getText()
							.toString(), latitude, longtitude, phone.getText()
							.toString(), district);
			if (rs == Config.ChangeMatchSuccsee) {
				Toast.makeText(ChangeMatchActivity.this, "修改成功",
						Toast.LENGTH_LONG).show();
				mIntent = new Intent(ChangeMatchActivity.this,
						MainActivity.class);
				...
				Toast.makeText(ChangeMatchActivity.this, "未知",
						Toast.LENGTH_LONG).show();
				break;
			} else {
				Toast.makeText(ChangeMatchActivity.this, "异常",
						Toast.LENGTH_LONG).show();
				break;
			}
			// 点击开始时间行，弹出日期选择框
