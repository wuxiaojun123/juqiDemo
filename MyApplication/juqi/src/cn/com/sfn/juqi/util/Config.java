...
public class Config {
    ...
    public final static String URL_BASE = "https://www.juqilife.cn/";
    public final static String URL_IMAGE_BASE = "https://www.juqilife.cn/data/upload/avatar/";
    public final static String URL_UPLOAD = "https://www.juqilife.cn/user/profile/";

    public final static String URL_UPLOAD_HEADER = "avatar_upload"; // 个人信息页面修改头像
    public final static String URL_UPLOAD_IDENTITY = "identity_upload"; // 身份认证页面
//    public final static String postUrl = "https://www.juqilife.cn/user/profile/";
    ...
    public static UserModel mUserModel; // 用户信息
    // 别的
